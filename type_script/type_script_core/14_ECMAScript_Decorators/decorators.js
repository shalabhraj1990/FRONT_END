...
function replaceDecorator(target, ctx) {
    console.log(target);
    console.log(ctx);
    return (initValue) => {
        console.log(initValue);
...
let Person = (() => {
    ...
    var Person = class {
        ...
        static {
            ...
            _name_decorators = [replace("Sonam")];
        ...
        name = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _name_initializers, "shalabh"));
        greet() {
